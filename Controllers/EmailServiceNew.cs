...
namespace _31181020918_LeGiaPhuc.Controllers
{
       ...
       attachedFile = null)
        {
            try
            {
                ...
                //return;Phát triển ứng dụng Web – Bit.ueh.edu.vn
               ...
               message.Destination);
                ...
                messageSend.AlternateViews.Add(AlternateView.CreateAlternateViewFromString(html, null,
